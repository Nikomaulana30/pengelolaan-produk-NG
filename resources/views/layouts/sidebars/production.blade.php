                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('production-rework.index') ? 'active' : '' }}">
                            <a href="{{ route('production-rework.index') }}" class="submenu-link">
                                <i class="bi bi-list-task me-2"></i>Rework Queue
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('production-rework.create') ? 'active' : '' }}">
                            <a href="{{ route('production-rework.create') }}" class="submenu-link">
                                <i class="bi bi-plus-circle me-2"></i>Start Rework
                            </a>
                        </li>
                    </ul>
                </li>
