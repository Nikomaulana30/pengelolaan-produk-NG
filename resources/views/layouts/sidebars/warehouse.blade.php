                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('warehouse-verification.index') ? 'active' : '' }}">
                            <a href="{{ route('warehouse-verification.index') }}" class="submenu-link">
                                <i class="bi bi-eye me-2"></i>Needs Verification
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('warehouse-verification.create') ? 'active' : '' }}">
                            <a href="{{ route('warehouse-verification.create') }}" class="submenu-link">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('return-shipment.index') ? 'active' : '' }}">
                            <a href="{{ route('return-shipment.index') }}" class="submenu-link">
                                <i class="bi bi-box-seam me-2"></i>Ready to Ship
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('return-shipment.create') ? 'active' : '' }}">
                            <a href="{{ route('return-shipment.create') }}" class="submenu-link">
                                <i class="bi bi-send me-2"></i>Create Shipment
                            </a>
                        </li>
                    </ul>
                </li>
