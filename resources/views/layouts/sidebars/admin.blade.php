    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <!-- MASTER DATA -->
                <li class="sidebar-title">Master Data Management</li>
                <li class="sidebar-item has-sub {{ request()->routeIs('master-customer.*', 'master-data.*', 'master-defect-type.*', 'master-produk.*', 'master-vendor.*', 'master-disposisi.*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-database text-info"></i>
                        <span>Master Data</span>
                    </a>
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('master-customer.*') ? 'active' : '' }}">
                            <a href="{{ route('master-customer.index') }}" class="submenu-link">
                                <i class="bi bi-person-lines-fill me-2"></i>Master Customer
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('master-produk.*') ? 'active' : '' }}">
                            <a href="{{ route('master-produk.index') }}" class="submenu-link">
                                <i class="bi bi-box me-2"></i>Master Produk
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('master-vendor.*') ? 'active' : '' }}">
                            <a href="{{ route('master-vendor.index') }}" class="submenu-link">
                                <i class="bi bi-building me-2"></i>Master Vendor
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('master-defect.*') ? 'active' : '' }}">
                            <a href="{{ route('master-defect.index') }}" class="submenu-link">
                                <i class="bi bi-exclamation-triangle me-2"></i>Master Defect
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('master-disposisi.*') ? 'active' : '' }}">
                            <a href="{{ route('master-disposisi.index') }}" class="submenu-link">
                                <i class="bi bi-arrow-left-right me-2"></i>Master Disposisi
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('master-lokasi-gudang.*') ? 'active' : '' }}">
                            <a href="{{ route('master-lokasi-gudang.index') }}" class="submenu-link">
                ...
                <!-- CUSTOMER RETURN: EXPORT/IMPORT DIVISION -->
                <li class="sidebar-title">Export/Import Workflow</li>
                <li class="sidebar-item has-sub {{ request()->routeIs('customer-complaint.*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-exclamation-triangle-fill text-danger"></i>
                        <span>Customer Complaint</span>
                    </a>
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('customer-complaint.index') ? 'active' : '' }}">
                            <a href="{{ route('customer-complaint.index') }}" class="submenu-link">
                                <span class="badge bg-danger me-2">1</span>Daftar Complaint
                            </a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('customer-complaint.create') ? 'active' : '' }}">
                            <a href="{{ route('customer-complaint.create') }}" class="submenu-link">
                                <span class="badge bg-danger me-2">+</span>Buat Complaint Baru
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('final-quality-check.index') ? 'active' : '' }}">
                            <a href="{{ route('final-quality-check.index') }}" class="submenu-link">
                                <span class="badge bg-success me-2">6</span>Pending Approval
                            </a>
                        </li>
                    </ul>
                </li>

                <!-- CUSTOMER RETURN: WAREHOUSE DIVISION -->
                <li class="sidebar-title">Warehouse Workflow</li>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('dokumen-retur.index') ? 'active' : '' }}">
                            <a href="{{ route('dokumen-retur.index') }}" class="submenu-link">
                                <span class="badge bg-info me-2">2</span>Incoming Returns
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item has-sub {{ request()->routeIs('warehouse-verification.*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('warehouse-verification.index') ? 'active' : '' }}">
                            <a href="{{ route('warehouse-verification.index') }}" class="submenu-link">
                                <span class="badge bg-warning me-2">3</span>Needs Verification
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item has-sub {{ request()->routeIs('return-shipment.*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-truck text-success"></i>
                        <span>Return Shipment</span>
                    </a>
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('return-shipment.index') ? 'active' : '' }}">
                            <a href="{{ route('return-shipment.index') }}" class="submenu-link">
                                <span class="badge bg-dark me-2">7</span>Ready to Ship
                            </a>
                        </li>
                    </ul>
                </li>

                <!-- CUSTOMER RETURN: QUALITY DIVISION -->
                <li class="sidebar-title">Quality Workflow</li>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('quality-reinspection.index') ? 'active' : '' }}">
                            <a href="{{ route('quality-reinspection.index') }}" class="submenu-link">
                                <span class="badge bg-primary me-2">4</span>Pending Inspection
                            </a>
                        </li>
                    </ul>
                </li>

                <!-- CUSTOMER RETURN: PRODUCTION DIVISION -->
                <li class="sidebar-title">Production Workflow</li>
                <li class="sidebar-item has-sub {{ request()->routeIs('production-rework.*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('production-rework.index') ? 'active' : '' }}">
                            <a href="{{ route('production-rework.index') }}" class="submenu-link">
                                <span class="badge bg-secondary me-2">5</span>Rework Queue
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-title">Analytics & Reports</li>
                <li class="sidebar-item {{ request()->routeIs('return-reports.*') ? 'active' : '' }}">
