...
@section('title', 'Edit Warehouse Verification')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Warehouse Verification</h3>
                <p class="text-subtitle text-muted">Update verifikasi penerimaan barang NG</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('warehouse-verification.show', $verification) }}">Detail</a></li>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Edit Verifikasi Warehouse</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('warehouse-verification.update', $verification) }}" method="POST" enctype="multipart/form-data" id="verificationForm">
                    @csrf
                    @method('PUT')

                    <!-- Dokumen Retur Info (Read-only) -->
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card bg-light">
                                <div class="card-body">
                                    <h5 class="card-title mb-3">
                                        <i class="bi bi-file-earmark-text me-2"></i>Dokumen Retur
                                    </h5>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                <strong>No. Dokumen:</strong>
                                                <span class="text-muted">{{ $verification->dokumenRetur->nomor_dokumen }}</span>
                                            </div>
                                            <div class="mb-2">
                                                <strong>Customer:</strong>
                                                <span class="text-muted">{{ $verification->dokumenRetur->customerComplaint->nama_customer }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                <strong>Produk:</strong>
                                                <span class="text-muted">{{ $verification->dokumenRetur->customerComplaint->produk }}</span>
                                            </div>
                                            <div class="mb-2">
                                                <strong>Quantity NG Expected:</strong>
                                                <span class="text-muted">{{ number_format($verification->dokumenRetur->customerComplaint->quantity_ng) }} pcs</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_terima') is-invalid @enderror" 
                                       ...
                                       value="{{ old('tanggal_terima', $verification->tanggal_terima->format('Y-m-d')) }}" required>
                        ...
                        <div class="col-md-6">
                                ...
                                <select class="form-select select2-lokasi @error('master_lokasi_gudang_id') is-invalid @enderror" 
                                    ...
                                    @foreach($lokasiGudangs as $lokasi)
                                        <option value="{{ $lokasi->id }}" 
                                                ...
                                                {{ old('master_lokasi_gudang_id', $verification->master_lokasi_gudang_id) == $lokasi->id ? 'selected' : '' }}>
                            ...
                            <!-- Lokasi Detail Info -->
                            <div id="lokasiDetail" style="display: {{ $verification->master_lokasi_gudang_id ? 'block' : 'none' }};" class="alert alert-info py-2">
                                <small>
                                    <strong>Kapasitas:</strong> <span id="lokasi_kapasitas">{{ $verification->lokasiGudang ? number_format($verification->lokasiGudang->kapasitas_max) : '' }} pcs</span><br>
                                    <strong>Penggunaan Saat Ini:</strong> <span id="lokasi_usage">{{ $verification->lokasiGudang ? number_format($verification->lokasiGudang->current_usage ?? 0) : '' }} pcs</span><br>
                                    <strong>Tersedia:</strong> <span id="lokasi_available">{{ $verification->lokasiGudang ? number_format(($verification->lokasiGudang->kapasitas_max ?? 0) - ($verification->lokasiGudang->current_usage ?? 0)) : '' }} pcs</span>
                                </small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('lokasi_penyimpanan') is-invalid @enderror" 
                                       ...
                                       value="{{ old('lokasi_penyimpanan', $verification->lokasi_penyimpanan) }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('quantity_diterima') is-invalid @enderror" 
                                       ...
                                       value="{{ old('quantity_diterima', $verification->quantity_diterima) }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('quantity_ng_confirmed') is-invalid @enderror" 
                                       ...
                                       value="{{ old('quantity_ng_confirmed', $verification->quantity_ng_confirmed) }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('quantity_ok') is-invalid @enderror" 
                                       ...
                                       value="{{ old('quantity_ok', $verification->quantity_ok) }}" required>
                                @error('quantity_ok')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('kondisi_fisik_barang') is-invalid @enderror" 
                                          ...
                                          required>{{ old('kondisi_fisik_barang', $verification->kondisi_fisik_barang) }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('catatan_penerimaan') is-invalid @enderror" 
                                          ...
                                          required>{{ old('catatan_penerimaan', $verification->catatan_penerimaan) }}</textarea>
                    ...
                    @if($verification->foto_barang_ng && count($verification->foto_barang_ng) > 0)
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="form-label">Foto Barang NG Saat Ini</label>
                                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <label for="foto_barang_ng" class="form-label">Tambah Foto Barang NG</label>
                                ...
                                @error('foto_barang_ng.*')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Upload foto tambahan kondisi barang NG (Multiple files allowed, Max: 2MB per file)</small>
                            </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('warehouse-verification.show', $verification) }}" class="btn btn-secondary">
                                    <i class="bi bi-arrow-left me-2"></i>Kembali
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-save me-2"></i>Update Verifikasi
                                </button>
                            </div>
                        </div>
                    </div>
