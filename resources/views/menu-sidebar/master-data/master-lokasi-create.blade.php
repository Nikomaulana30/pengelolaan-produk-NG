...
@section('title', 'Tambah Master Lokasi')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8">
                    <h3><i class="bi bi-building"></i> Tambah Master Lokasi</h3>
                    <p class="text-subtitle text-muted">Tambahkan lokasi penyimpanan barang baru di gudang</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Form Tambah Master Lokasi</h5>
                    <p class="text-muted small">Lengkapi data lokasi penyimpanan barang</p>
                </div>
                <div class="card-body">
                    <form action="{{ route('master-lokasi.store') }}" method="POST" class="needs-validation">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('kode_lokasi') is-invalid @enderror" 
                                               id="kode_lokasi" name="kode_lokasi" placeholder="Contoh: RAK-A-01, LOC-001"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('zona_gudang') is-invalid @enderror" 
                                            ...
                                            <option value="zona_a" @selected(old('zona_gudang') === 'zona_a')>Zona A</option>
                                            <option value="zona_b" @selected(old('zona_gudang') === 'zona_b')>Zona B</option>
                                            <option value="zona_c" @selected(old('zona_gudang') === 'zona_c')>Zona C</option>
                                            <option value="zona_d" @selected(old('zona_gudang') === 'zona_d')>Zona D</option>
                                            <option value="zona_e" @selected(old('zona_gudang') === 'zona_e')>Zona E</option>
                                        </select>
                                        @error('zona_gudang')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('tipe_lokasi') is-invalid @enderror" 
                                            ...
                                            <option value="regular" @selected(old('tipe_lokasi') === 'regular')>
                                                🟢 Regular (Stok Normal)
                                            </option>
                                            <option value="karantina" @selected(old('tipe_lokasi') === 'karantina')>
                                                🟡 Karantina (NG/Hold)
                                            </option>
                                            <option value="ng_storage" @selected(old('tipe_lokasi') === 'ng_storage')>
                                                🔴 NG Storage (Penyimpanan NG)
                                            </option>
                                            <option value="scrap" @selected(old('tipe_lokasi') === 'scrap')>
                                                ⚫ Scrap (Barang Rusak)
                                            </option>
                                        </select>
                                        @error('tipe_lokasi')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('status_lokasi') is-invalid @enderror" 
                                            ...
                                            <option value="available" @selected(old('status_lokasi') === 'available' || old('status_lokasi') === null)>
                                                ✓ Available (Tersedia)
                                            </option>
                                            <option value="full" @selected(old('status_lokasi') === 'full')>
                                                ✗ Full (Penuh)
                                            </option>
                                            <option value="maintenance" @selected(old('status_lokasi') === 'maintenance')>
                                                ⚙ Maintenance (Perbaikan)
                                            </option>
                                            <option value="blocked" @selected(old('status_lokasi') === 'blocked')>
                                                ⛔ Blocked (Terblokir)
                                            </option>
                                        </select>
                                        @error('status_lokasi')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control @error('kapasitas_maksimal') is-invalid @enderror" 
                                               ...
                                               value="{{ old('kapasitas_maksimal') }}" min="0">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Catatan tambahan tentang lokasi ini...">{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="alert alert-info" role="alert">
                            ...
                            <ul class="mb-0 mt-2">
                                <li>Kode Lokasi harus unik dan tidak dapat diubah setelah dibuat</li>
                                <li>Tipe <strong>Quarantine</strong> digunakan untuk menyimpan barang defect/NG</li>
                                <li>Tipe <strong>Temporary</strong> adalah staging area untuk proses penerimaan</li>
                                <li>Lokasi non-aktif tidak akan muncul di dropdown form input</li>
                            </ul>
                        </div>
