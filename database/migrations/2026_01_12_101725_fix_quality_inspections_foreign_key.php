...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('quality_inspections', function (Blueprint $table) {
            try {
                $table->dropForeign('quality_inspections_kode_barang_foreign');
            } catch (\Exception $e) {
                // FK might not exist
                \Log::warning('FK quality_inspections_kode_barang_foreign not found: ' . $e->getMessage());
            }
        });
        ...
        echo "✅ Quality inspections foreign key fixed!\n";
    }
